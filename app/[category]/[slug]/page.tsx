...
export async function generateMetadata({params}:Props):Promise<Metadata>{
 ...
 const title=`${plan.name} Premium & Maturity Calculator`;
 return {title,description:plan.description,alternates:{canonical:planPath(plan)},openGraph:{title,description:plan.description,type:'website'}};
}
